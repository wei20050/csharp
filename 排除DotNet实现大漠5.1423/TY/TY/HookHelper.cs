    ...
    public class HookHelper
    {
        ...
        public void SetHook()
        {
            ...
            if (processModule != null)
                _hKeyboardHook = (int)SetWindowsHookEx(WhKeyboardLl, _keyboardHookProcedure,
        ...
        private int KeyboardHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if (nCode >= 0 && (KeyDownEvent != null || KeyUpEvent != null || KeyPressEvent != null))
            {
                ...
                //按下控制键
                if ((KeyDownEvent != null || KeyPressEvent != null) && (wParam == WmKeydown || wParam == WmSysKeyDown))
                {
                ...
                //松开控制键
                if ((KeyDownEvent != null || KeyPressEvent != null) && (wParam == WmKeyup || wParam == WmSysKeyUp))
                {
